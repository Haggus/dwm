...
static const char *colors[][3]      = {
	...
	[SchemeHid]  = { col_gray1, col_gray4, col_green },
};
...
static const char *passmenucmd[]    = { "passmenu", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_green, "-sf", col_gray1, NULL };
static const char *screencmd[]      = { "flameshot", "gui", NULL };
static const char *filemanagercmd[] = { "alacritty", "-e", "nnn", NULL };
